...
},{"process":"../node_modules/process/browser.js"}],"functions.js":[function(require,module,exports) {
"use strict";
...
$(function () {
  ...
  $("button.ajaxButton").click(function () {
    $.getJSON("https://jsonplaceholder.typicode.com/todos/1", {
      format: "json" // $("#ajaxResponse").html("JSON Data: " + "title: " + json.title + "useID " + json.id );
      // console.log( "JSON Data: " + "title: " + json.title + "useID " + json.id );

    }).done(function (data) {
      console.log("data: ", data);
      $.each(data, function (i, item) {
        console.log(i + ": ", item); //   $( "<img>" ).attr( "src", item.media.m ).appendTo( "#images" );
        //   if ( i === 3 ) {
        //     return false;
        //   }
      });
...
},{"bootstrap":"../node_modules/bootstrap/dist/js/bootstrap.esm.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
